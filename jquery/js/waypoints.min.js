...
!(function () {
    ...
    (function () {
        ...
        var e = window.jQuery,
            i = window.Waypoint
        e.each(['innerHeight', 'innerWidth', 'off', 'offset', 'on', 'outerHeight', 'outerWidth', 'scrollLeft', 'scrollTop'], function (
            e,
            i
        ) {
        ...
        function (e, t) {
            ...
            function o(e, t) {
                r.push({ selector: e, fn: t }),
                    !c && a && ((c = new a(n)), c.observe(i.documentElement, { childList: !0, subtree: !0, removedNodes: !0 })),
                    n()
            }
            function n() {
