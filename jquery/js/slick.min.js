    ...
    ;(b = (function () {
        function c(c, d) {
            ...
            ;(e.defaults = {
                ...
                customPaging: function (a, b) {
                    return (
                        '<button type="button" data-role="none" role="button" aria-required="false" tabindex="0">' + (b + 1) + '</button>'
                    )
                },
                dots: !1,
        ...
        (b.prototype.refresh = function (b) {
            ...
            ;(e = c.slideCount - c.options.slidesToShow),
                c.options.infinite ||
                    (c.slideCount <= c.options.slidesToShow ? (c.currentSlide = 0) : c.currentSlide > e && (c.currentSlide = e)),
                (d = c.currentSlide),
                c.destroy(!0),
        ...
        (b.prototype.selectHandler = function (b) {
            ...
            return (
                e || (e = 0), c.slideCount <= c.options.slidesToShow ? (c.setSlideClasses(e), void c.asNavFor(e)) : void c.slideHandler(e)
            )
        }),
                    ...
                    : (b === !1 && i.asNavFor(a),
                      ...
                      i.options.infinite === !1 && i.options.centerMode === !1 && (0 > a || a > i.getDotCount() * i.options.slidesToScroll)
                          ...
                          : (i.options.autoplay === !0 && clearInterval(i.autoPlayTimer),
                            ...
                            i.options.beforeChangeSync ? i.options.beforeChangeSync() : '',
                            (f = i.currentSlide),
                            (i.currentSlide = e),
