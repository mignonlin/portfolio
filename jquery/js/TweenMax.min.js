            ...
            function (a, b, c) {
                ...
                return (
                    ...
                    (q.addPause = function (a, b, d, e) {
                        ...
                        return (
                            (f.vars.onComplete = f.vars.onReverseComplete = b), (f.data = 'isPause'), (this._hasPause = !0), this.add(f, a)
                        )
                    }),
                ...
                var k,
                    ...
                    T = (function () {
                        ...
                        return (
                            ...
                            (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(S) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(S)) &&
                    ...
                    la = function (a, b, c) {
                        return (
                            (a = 0 > a ? a + 1 : a > 1 ? a - 1 : a),
                            (255 * (1 > 6 * a ? b + (c - b) * a * 6 : 0.5 > a ? c : 2 > 3 * a ? b + (c - b) * (2 / 3 - a) * 6 : b) + 0.5) |
                                0
                        )
                    },
                ...
                ;(oa = new RegExp(oa + ')', 'gi')),
                    (g.colorStringFilter = function (a) {
                        var b,
                            c = a[0] + a[1]
                        oa.test(c) &&
                            ((b = -1 !== c.indexOf('hsl(') || -1 !== c.indexOf('hsla(')), (a[0] = na(a[0], b)), (a[1] = na(a[1], b))),
                            (oa.lastIndex = 0)
                    }),
                                ...
                                ? (g.l++,
                                  ...
                                  h > 0
                                      ? ((g.data['xn' + h] = b + c),
                                        ...
                                        (g['xn' + h] = b),
                                        g.plugin ||
                                            ((g.xfirst = new sa(g, 'xn' + h, b, c, g.xfirst || g, 0, g.n, e, g.pr)), (g.xfirst.xs0 = 0)),
                                        g)
                                ...
                                if (((d._transform = C), D && 'string' == typeof D && Ba))
                                    (l = P.style),
                                        ...
                                        C.svg &&
                                            ...
                                            (p || s) &&
                                                ((t = Oa(P, !0)), (k.x -= p - (p * t[0] + s * t[2])), (k.y -= s - (p * t[1] + s * t[3])))),
                        ...
                        parser: function (a, b, c, d, f, g) {
                            ...
                            return (
                                ...
                                this.parseComplex(
                                    a.style,
                                    this.format(
                                        h + ' ' + $(a, 'borderTopStyle', e, !1, 'solid') + ' ' + $(a, 'borderTopColor', e, !1, '#000')
                                    ),
                                    i.join(' '),
                                    f,
                                    g
                ...
                for (
                    xa('clearProps', {
                        parser: function (a, b, d, e, f) {
                            return (
                                (f = new sa(a, d, 0, 0, f, 2)), (f.setRatio = Va), (f.e = b), (f.pr = -10), (f.data = e._tween), (c = !0), f
                            )
                        },
                    }),
                                ...
                                z = 3 === this._transformType,
                                    Ba
                                        ? m &&
                                          ((l = !0),
                                          '' === A.zIndex &&
                                              ((w = $(a, 'zIndex', e)), ('auto' === w || '' === w) && this._addLazySet(A, 'zIndex', 0)),
                                          o &&
                                              this._addLazySet(
                                                  A,
