...
!(function (a, b) {
    ...
    ;(n.event = {
        ...
        n.each({ mouseenter: 'mouseover', mouseleave: 'mouseout', pointerenter: 'pointerover', pointerleave: 'pointerout' }, function (
            a,
            b
        ) {
            n.event.special[a] = {
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    .filter(function () {
                        var a = this.type
                        return (
                            this.name && !n(this).is(':disabled') && zb.test(this.nodeName) && !yb.test(a) && (this.checked || !T.test(a))
                        )
                    })
                    .map(function (a, b) {
                        var c = n(this).val()
